...
class Task(models.Model):
    ...
    status = models.ForeignKey('tasks.Status', related_name='task_status', on_delete=models.PROTECT, null=True, blank=True, verbose_name='статус')
    type = models.ForeignKey('tasks.Type', related_name='task_type', on_delete=models.PROTECT, null=True, blank=True, verbose_name='тип')
    project = models.ForeignKey('tasks.Project', related_name='projects_task', on_delete=models.PROTECT, null=True, blank=False, verbose_name='проект')
    ...
    assigned_to = models.ForeignKey(User, max_length=40, null=True, blank=True, on_delete=models.CASCADE,
